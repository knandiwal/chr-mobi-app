...
import com.dianping.ba.crm.Mobile.CrmSalesforceDroidGapActivity;
...
public class GAPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callback) {
        ...
        } else if (action.equals("setCustomMetric")) {
            try {
        ...
        } else if (action.equals("getLoginInfo")) {
            try {
                JSONObject result = new JSONObject();
                result.put("time", CrmSalesforceDroidGapActivity.startTime);
                result.put("type", CrmSalesforceDroidGapActivity.loginType);
